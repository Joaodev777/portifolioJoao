...
<head>
    ...
    <title>Cybrix Corporation</title>
    <style>
        .whatsapp-fixed {
            position: fixed;
            bottom: 40px;
...
<body style="background:#1e1d2a; color: white;">
    <nav class="nav" id="nav">
        <div class="nav-title" id="title-nav"><a href="index.html" style="text-decoration: none;font-size:45px"><img scr="img/logo-off.png.png"></a></div>
    ...
    <div class="cont-wi" style="width: 100%;">
        ...
        <div class="d-block">
            ...
            <br>
            <div class="conteiner apre" style="margin-top:8vh;">
                ...
                <div class="models">
                    ...
                    <div class="box__models">
                        <div class="content-text-hover"><a href="loja-cell-new/index.php" target="_blank">
                                <div class=" content-text">
                                    <img src="img/2023-07-13_20-54.png" alt="">
