...
<body style="background:#1e1d2a; color: white;">
  ...
  <div class="rs-video whatsapp-fixed">
    <div class="animate-border">
      <a alt="Whatsapp" class="video-vemo-icon btn-whatsapp" aria-label="WhatsApp"
        href="http://api.whatsapp.com/send?1=pt_BR&amp;phone=5537999066606" target="_blank" rel="noopener noreferrer"
      ...
      <div class=" mt-5">
        <div class=" d-flex">
          <div class="d-block gtx">
            ...
            <div class="name">
              <div class=" joaoname"><span class="nameone"> João</span> <span class="nametwo">Guilherme</span> </div>
            </div>
            <div class="icons">
              ...
              <a href="https://github.com/Joao-Soaress" target="_blank"><img src="img/icons8-github-48.png" alt=""></a>
            </div>
            <div class="div">
              <div class="btn-gtx gradient-border mb-5 btn-side">
                <button class="btn-dark btn-general-m1 text-light"><a href="joao.html" target="_blank">Saiba
                    mais</a></button>
              </div>
              <div class=" btn-gtx gradient-border mb-5 btn-con btn-side btn-si">
                <button class="btn-dark btn-general-m1 text-light"><a href="joao.html" target="_blank">Faça seu
                    orçamento</a></button>
              </div>
          ...
          <div class="main">
            <a href="saibamais.htlm" target="_blank">
              ...
              <img src="img/svgviewer-output (8).png " class="img-abrend" style="  margin-top: 20vh;    height: 35vh; "
                alt="">
            </a>
          </div>
        </div>
  ...
  <div class="d-block">
    ...
    <div class="conteiner apre">
      <div class="apresentacao d-flex" style="width: 100%;background-color: rgb(37, 37, 37);">
        <div class="img-joao-gtx"><img class="border-img" src="https://img.icons8.com/ios/100/000000/user--v1.png"
            alt="user--v1" / style="border-radius: 50%;" alt="">
        </div>
        <div class="text-apre-gtx1 text-center mt-1">
          ...
          <div class="content font-5 mt-3">
            <p>Ola, me chamo <span class="Joao">João Guilherme</span> um desenvolvedor web apaixonado pelo que
              faço. Desde 2015, tenho me dedicado incansavelmente a aprimorar minhas habilidades e conhecimentos
              nesse campo em constante evolução. </p>
          </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12 align-self-center text-center" style="margin: 0 auto;">
          ...
          <p class="description-section">
            ...
            empresas e empreendedores. Nossa missão é ajudar nossos clientes a alcançar seus objetivos de negócio
            através da criação de uma presença online impactante e eficaz.
          </p>
          <p class="description-section">
            Durante minha jornada como desenvolvedor de software, mergulhei em diversos desafios e oportunidades de
            aprendizado que me permitiram aprimorar minhas habilidades e me tornar um especialista nessas áreas. Ao
          ...
          <div class="img-cont">
            ...
            <img
              src="img/png-clipart-batch-file-computer-icons-computer-file-ms-dos-cmd-icon-electronics-commandline-interface.png"
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
              <div class="card bg-dark">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/sass/sass-original.svg" alt=""
                  class="card-img-top">
                <button class="bnt cont-btn" data-bs-toggle="modal" data-bs-target="#modalscss">Sass</button>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="content-text-hover"><a href="restaurante-exemplo/index.html">
                  <div class="content-text">
                    ...
                    <div class="text-card">
                      ...
                      <span>Este é um site foi desenvolvido para restaurantes, com uma página inicial atraente. Logo
                        abaixo, você encontrará informações de localização e um sistema onde os pedido são enviados
        ...
        <div class="box__models">
          <div class="content-text-hover"><a href="loja-cell-new/index.php"">
              ...
              <div class="text-card">
                ...
                <span>Esse site em especifico, foi ultilizado um sistema para lhe ajudar a organizar suas finanças no
      ...
      <div class="content-text-hover"><a href="consorcio/index.html" target="_blank">
          <div class="content-text">
            ...
            <div class="text-card">
              ...
              <span>A estrutura do site é excelente, facilitando a navegação. A combinação de cores transmite
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h6>HTML (HyperText Markup Language) é a linguagem de marcação padrão para a criação e estruturação de
            páginas web. Ele define a estrutura e os elementos que compõem uma página, como títulos, parágrafos,
            imagens, links e muito mais. Com o HTML, você pode criar a estrutura básica de uma página web e definir
  ...
  <div class="modal fade" id="modalcss" tabindex="-1" aria-labelledby="meuModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h6>CSS (Cascading Style Sheets) é uma linguagem de estilo usada para definir a aparência e o layout de
            elementos HTML em uma página web. Com o CSS, você pode controlar a cor, o tamanho, a fonte, o
            espaçamento e outros aspectos visuais dos elementos. Ele permite separar a estrutura e o conteúdo do
            estilo, oferecendo uma maior flexibilidade na personalização e na criação de um design atraente e
            consistente.</h6>
        </div>
    ...
    <div class="respo">
      ...
      <div class="login-box">
        <form data-aos="fade-left" data-aos-delay="700" data-aos-easing="ease-in" data-aos-duration="1000"
          ...
          <input type="text" name="name" class="inputs" style="width: 40vh;border: none;outline: none;color: #1e1d2a;"
            placeholder="Seu nome" required=""><br>
          <input type="email" name="email" class="inputs" style="width:40vh;border: none;outline: none;color: #1e1d2a;"
  ...
  <div class="modal fade" id="meujs" tabindex="-1" aria-labelledby="meuModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h6>JavaScript é uma linguagem de programação de alto nível que é executada no navegador do cliente. Ele
            permite adicionar interatividade, comportamento dinâmico e manipulação de elementos HTML em uma página
            web. Com o JavaScript, você pode responder a eventos, criar animações, validar formulários, fazer
            requisições para servidores e muito mais. É uma linguagem poderosa que permite a criação de aplicativos
  ...
  <div class="modal fade" id="meuvue" tabindex="-1" aria-labelledby="meuModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h6>
            Vue.js é um framework JavaScript progressivo e de código aberto usado para criar interfaces de usuário
            (UI) interativas e reativas. Ele permite que você crie componentes reutilizáveis e os combine para
            construir aplicativos web complexos. O Vue.js adota uma abordagem baseada em componentes, facilitando a
            criação, manutenção e reutilização de código. Ele oferece recursos avançados, como manipulação de dados
            reativa, diretivas personalizadas, roteamento e gerenciamento de estado. Com o Vue.js, é possível criar
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h6>Batch Scripting (ou Windows Batch Scripting) é uma linguagem de programação utilizada no sistema
            operacional Windows para criar scripts que automatizam tarefas relacionadas ao sistema. Os arquivos em
  ...
  <div class="modal fade " id="modalsaiba" tabindex="-1" aria-labelledby="meuModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content modal-co bg-dark text-light" style="width: calc(500px + 80px );">
        <div class="modal-header ">
        ...
        <div class="modal-body" style="height: 360px;">
          <div class="before_name">Bem Vindo!</div>
          <div class="d-flex">
  ...
  <div class="modal fade " id="modalscss" tabindex="-1" aria-labelledby="meuModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>SCSS (Sassy CSS) é uma extensão do CSS que traz recursos avançados para a estilização de páginas web.
          ...
          <ul>
            <li><strong>Variáveis:</strong> Com o SCSS, você pode definir variáveis para reutilizar valores, como
              cores, tamanhos de fonte e margens, em diferentes partes do seu código. Isso facilita a manutenção e a
              atualização de estilos em toda a sua aplicação.</li>
            <li><strong>Aninhamento:</strong> O SCSS permite aninhar seletores CSS, tornando mais intuitiva a
              estrutura do seu código. Você pode escrever estilos para elementos aninhados dentro de outros
              elementos, tornando o código mais legível e organizado.</li>
            <li><strong>Mixins:</strong> Outra característica poderosa do SCSS são os mixins, que permitem criar
              blocos de código reutilizáveis. Você pode definir um mixin para um conjunto de estilos e, em seguida,
              chamá-lo em diferentes partes do seu código, evitando repetição e tornando seu código mais modular.
            </li>
            <li><strong>Importação de arquivos:</strong> O SCSS oferece suporte à importação de arquivos, permitindo
              dividir seu código em vários arquivos SCSS menores e importá-los conforme necessário. Isso ajuda a
              organizar seus estilos em módulos independentes e facilita a colaboração em projetos maiores.</li>
          </ul>

          <p>Para utilizar o SCSS, você precisa compilar seu código em CSS regular, que é o formato entendido pelos
          ...
          <p>O SCSS é uma ferramenta poderosa para estilização de páginas web, permitindo que você escreva CSS de
            forma mais eficiente, modular e fácil de manter. Ao adotar o SCSS, você pode melhorar significativamente
            o fluxo de trabalho de desenvolvimento front-end e criar estilos mais robustos e escaláveis para seus
            projetos.</p>
        </div>
