...
<head>
    ...
    <link rel="shortcut icon" href="img/logo-off.png" type="image/x-icon">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg position-fixed" id="nav" style="width: 100%; top: 0; z-index: 9999;">
        <div class="container-fluid">
            <a class="navbar-brand text-light" style="font-size: 30px" href="#home"><img src="img/logo-off.png"></a>
    ...
    <div class="container bg-light text-dark">
        ...
        <div class="mt-4 print-section">
            <h2>Transações -  <img src="img/logo-off.png"></h2>
